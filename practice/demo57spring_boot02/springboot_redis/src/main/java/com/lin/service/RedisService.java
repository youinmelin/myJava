...
/**
 *  https://blog.csdn.net/cocoivan1992/article/details/93192104
    ...
    public void del(String... keys) {
        if (keys != null && keys.length > 0) {
            if (keys.length == 1) {
                ...
                // CollectionUtils.arrayToList(数组) 将数组转换为ArrayList
